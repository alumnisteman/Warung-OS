...
export const getListRestockRecommendationsUrl = () => {




  return `/api/dashboard/restock-recommendations`
}

/**
 * @summary List restock recommendations
 */
export const listRestockRecommendations = async ( options?: Parameters<typeof customFetch>[1]): Promise<RestockRecommendation[]> => {

  return customFetch<RestockRecommendation[]>(getListRestockRecommendationsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListRestockRecommendationsQueryKey = () => {
    return [
    `/api/dashboard/restock-recommendations`
    ] as const;
    }


export const getListRestockRecommendationsQueryOptions = <TData = Awaited<ReturnType<typeof listRestockRecommendations>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listRestockRecommendations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListRestockRecommendationsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listRestockRecommendations>>> = ({ signal }) => listRestockRecommendations({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listRestockRecommendations>>, TError, TData> & { queryKey: QueryKey }
}

export type ListRestockRecommendationsQueryResult = NonNullable<Awaited<ReturnType<typeof listRestockRecommendations>>>
export type ListRestockRecommendationsQueryError = ErrorType<unknown>
...
export function useListRestockRecommendations<TData = Awaited<ReturnType<typeof listRestockRecommendations>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listRestockRecommendations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getListRestockRecommendationsQueryOptions(options)
