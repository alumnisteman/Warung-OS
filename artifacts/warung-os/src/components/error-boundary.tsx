    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-background p-6 text-foreground">
      <div className="max-w-lg w-full text-center">
        <h1 className="font-serif text-xl font-bold">
          Ada bagian yang tersendat
        </h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Coba muat ulang bagian ini. Data warung tetap aman.
        </p>
        ...
        <button
          type="button"
          onClick={resetError}
          className="mt-4 rounded-xl bg-primary px-4 py-2 text-sm font-bold text-primary-foreground hover:opacity-90"
        >
          Coba lagi
        </button>
      </div>
